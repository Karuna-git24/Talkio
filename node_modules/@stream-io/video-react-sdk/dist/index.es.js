...
import { useCall, useCallStateHooks, useI18n, Restricted, useToggleCallRecording, useConnectedUser, useIsAudioConnecting, StreamCallProvider, StreamVideoProvider, useStreamVideoClient, useEffectEvent } from '@stream-io/video-react-bindings';
...
const BackgroundFiltersProviderImpl = lazy(() => import('./background-filters-D2U5UBbH.es.js').then((m) => ({
...
const [major, minor, patch] = ("1.37.0").split('.');
setSdkInfo({
